...
function ClientBase(opts) {
  ...
  // XOR
  if (!(api ^ oauth)) {
    var warningStr = "You have not provided an apiKey and apiSecret or an accessToken. You will only be able to make requests to public APIs which do not require authentication. See the full documentation for these endpoints at can be found at https://developers.coinbase.com/api/v2#data-endpoints"
