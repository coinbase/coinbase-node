...
//## getSubscriptions
// returns an array of Subscription object instances associated with this `Account`.
//
//```
//myAccount.getSubscriptions(1, 10, function(err, subscriptions) {
...
// page 1 of size 10 and get an array of size 10, you should request page
// 2 next.  If page 2 returns 3 items or any count smaller than `limit`, you
// have all the `Subscriptions`_
//
// [See Coinbase list-subscriptions API Documentation](https://developers.coinbase.com/api#list-subscriptions)
// - - -
Account.prototype.getSubscriptions = function(page, limit, callback) {

  var opts = {
    'path'     : 'subscribers',
    'colName'  : 'recurring_payments',
    'typeName' : 'recurring_payment',
    'ObjFunc'  : Subscription,
    'page'     : page,
    'limit'    : limit
  };
...
//## getSubscription
// returns an Subscription object instance associated with this `Account`.
//
//```
//myAccount.getSubscription('O1234', function(err, subscription) {
//  // process subscription
//});
//```
// _arg subscription_id is required_
// [See Coinbase show-a-subscription API Documentation](https://developers.coinbase.com/api#show-a-subscription)
// - - -
Account.prototype.getSubscription = function(subscription_id, callback) {
