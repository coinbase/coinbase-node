...
//##CONSTRUCTOR
//
//  Arg `apiKey` is required. See [Coinbase Auth API](https://coinbase.com/settings/api).
//
//  Arg `apiSecret` is required.  See [Coinbase Auth API](https://coinbase.com/settings/api).
//
//  Arg `baseApiUrl` is optional and defaults to https://api.coinbase.com/v1/.
//
//  Arg `tokenUrl` is optional and defaults to https://www.coinbase.com/oauth/token.
//
...
//   'baseApiUri'   : 'https://sandbox.coinbase.com/v1/',
//   'tokenUri'     : 'https://sandbox.coinbase.com/oauth/token',
//   'accessToken'  : '09877654321',
//   'refreshToken' : 'R09877654321'
// };
